...
namespace GameMasterArena.Service.Services.Notifications;

public class MailSender : IMailSender
{
    private readonly string _myMail = "quehubverify@gmail.com";
    private readonly string _password = "qswxbrcilxiugqdk";
